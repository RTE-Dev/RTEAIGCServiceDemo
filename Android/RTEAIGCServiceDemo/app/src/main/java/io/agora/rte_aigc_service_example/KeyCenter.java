...
public class KeyCenter {
    ...
    public static boolean validKeys() {
        return !TextUtils.isEmpty(BuildConfig.LINGYI_KEY) && !TextUtils.isEmpty(BuildConfig.LINGYI_HOST) && !TextUtils.isEmpty(BuildConfig.APP_ID) && !TextUtils.isEmpty(BuildConfig.APP_CERTIFICATE);
    }
